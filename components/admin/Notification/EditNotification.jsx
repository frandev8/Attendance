...
import { mutateNotification, queryClient } from "../../../utils/http";
...
const ModalOverlay = ({ closeModal, notificationDetails }) => {
...
export const EditNotification = ({ closeModal, notificationDetails }) => {
  return (
    <>
      {createPortal(
